...
class ToursTest < ApplicationSystemTestCase
  ...
  test "creating a Tour" do
    ...
    fill_in "Descrizioneing", with: @tour.descrizioneing
    fill_in "Durata", with: @tour.durata
    fill_in "Giorniorarip", with: @tour.giorniorarip
    fill_in "Luogopartenza", with: @tour.luogopartenza
    fill_in "Maxpartecipanti", with: @tour.maxpartecipanti
