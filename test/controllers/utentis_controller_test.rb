...
class UtentisControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create utenti" do
    assert_difference('Utenti.count') do
      post utentis_url, params: { utenti: { cognome: @utenti.cognome, email: @utenti.email, indirizzo: @utenti.indirizzo, nome: @utenti.nome, note: @utenti.note, numero: @utenti.numero } }
    end
  ...
  test "should update utenti" do
    patch utenti_url(@utenti), params: { utenti: { cognome: @utenti.cognome, email: @utenti.email, indirizzo: @utenti.indirizzo, nome: @utenti.nome, note: @utenti.note, numero: @utenti.numero } }
